...
def test_kappa_positive(cosmo):
    assert kappa(50.0, jnp.array(100.0), jnp.array(1e-4)) > 0


def test_kappa_neutral_gas(cosmo):
...
def test_kappa_increases_with_temperature(cosmo):
...
def test_xc_positive_and_increases_with_density(cosmo):
