...
If you have a new feature/bug report, make sure you create an [issue](https://github.com/htjb/hyprfine/issues), and consult existing ones first, in case your suggestion is already being addressed.
...
To try and maintain a consistent style the code base is using pre-commit, ruff and isort. If you are ready to contribute to `hyprfine` please follow the instructions below before making a PR.
